...
>>>>>>> ad11f51dc485 (bpf: Add struct bpf_tcp_sock and BPF_FUNC_tcp_sock)
}
...
>>>>>>> aaeb50da4e78 (bpf: add meta pointer for direct access)
{
...
>>>>>>> 2c40c4f3b0ec (bpf: properly enforce index mask to prevent out-of-bounds speculation)
				return -EINVAL;
